# Generated by Django 3.0.3 on 2020-02-10 17:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('world_premiere', models.DateField(default=datetime.date.today, verbose_name='Примьеры в мире')),
                ('budget', models.PositiveSmallIntegerField(default=0, help_text='указать сумму в доларах', verbose_name='Бюджет')),
                ('fees_in_usa', models.PositiveSmallIntegerField(default=0, help_text='указать сумму в доларах', verbose_name='Сборы в США')),
                ('fees_in_world', models.PositiveSmallIntegerField(default=0, help_text='указать сумму в доларах', verbose_name='Сборы в мире')),
                ('url', models.SlugField(max_length=160, unique=True)),
