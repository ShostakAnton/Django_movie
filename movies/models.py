...
class Movie(models.Model):
    ...
    world_premiere = models.DateField("Примьеры в мире", default=date.today)
    ...
    fees_in_usa = models.PositiveSmallIntegerField(
        "Сборы в США", default=0, help_text="указать сумму в доларах"
    )
    fees_in_world = models.PositiveSmallIntegerField(
        "Сборы в мире", default=0, help_text="указать сумму в доларах"
    )
